...
const Toast = ({ message, type = 'info', isVisible, onClose, duration = 5000 }) => {
  ...
  const getToastStyles = () => {
    ...
    switch (type) {
      case 'success':
        return `${baseStyles} bg-green-600 text-white border-l-4 border-green-800`;
      case 'error':
        return `${baseStyles} bg-red-600 text-white border-l-4 border-red-800`;
      case 'warning':
        return `${baseStyles} bg-yellow-500 text-white border-l-4 border-yellow-700`;
      default:
        return `${baseStyles} bg-blue-600 text-white border-l-4 border-blue-800`;
    }
  };
