...
const Cardcomponent=({ className,item ,title,reverse })=> {
  return (    
    <div className={cn("w-screen h-auto lg:px-24  flex flex-col items-center ",className)}>
       ...
       {title&&
        <div className='w-screen text-4xl font-semibold text-gift_blue font-poppins pb-20 lg:flex-none flex justify-center'>
        {title}
         </div>
       }
            ...
            <div key={index} className= {cn("max-w-screen  max-h-screen flex lg:flex-row flex-col justify-center   ",alignment==="first"?"lg:flex-row-reverse":"lg:flex-row")}>
               ...
               <div className=" lg:w-[75%] lg:h-screen w-screen   flex flex-col  justify-center  ">
                ...
                <p className="lg:py-12 py-5 lg:text-xl text-xs font-normal font-poppins text-center px-8">
                 ...
                 <div className='relative lg:w-1/3 lg:h-screen h-[400px]   w-screen ' >
                    ...
                    <img src={items.image3} alt="" className={cn("absolute lg:w-[512px] lg:h-[351px] w-[255.87px] h-[175.6px] rounded-3xl bottom-40 right-20",alignment==="first"?"lg:left-20 left-24":"lg:right-20 right-24")} />
                </div>  
