...
function community() {
  return (
    <div className=' h-screen w-screen pt-20'>
        ...
        <div className='flex flex-col gap-5 items-center px-10 lg:px-8'>
           ...
           <div className='text-sm md:text-lg lg:text-2xl font-poppins font-normal text-center w-[90%] md:w-3/4 text-primary_color'>
