  ...
  return (
    <div className=' h-screen w-screen pt-20'>
        ...
        <div className='flex flex-col gap-5 items-center'>
           ...
           Behind every custom gift at EFTA is a vibrant community of artisans, designers, students, handicaped people and makers who bring your ideas to life. Our team is a diverse group of talented individuals who share a passion for creativity and craftsmanship.
           </div>
        </div>
        </div>
  )
