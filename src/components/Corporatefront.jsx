...
function Coperatefront() {
  return (
    <div className='max-h-screen  h-screen w-screen  items-center flex'>
        <img src="./coperatefront.png" alt="" className='absolute object-cover w-screen object-center' />
        <div className='z-10 px-24 flex flex-col gap-14'>
          <div className='flex flex-col gap-6'>
          <p className='text-4xl font-poppins font-semibold text-white'>Brand your</p>
