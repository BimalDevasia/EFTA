...
const EnquiryPage = () => {
  return (
    <Wrapper className="pt-40">
      <div>
        <div className="grid grid-cols-[60%_50%] max-w-[1074px] mx-auto">
          <div className="flex flex-col h-full items-center justify-center w-full">
            <svg
              className="w-24 h-24 fill-gift_blue"
              viewBox="0 0 121 54"
            ...
            <p className="text-[10px] font-poppins text-black">
              Our team will reach back to you
            </p>
            <form className="space-y-5 mb-10 w-full">
              <Input className="w-full max-w-[auto] bg-white" label="Name" />
              <Input className="w-full max-w-[auto] bg-white" label="Email" />
              <div className="w-full border-[#DBDBDB] border rounded-sm">
                <input
                  className={cn("px-[19px] py-[22px] w-full")}
