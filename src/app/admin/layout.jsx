  ...
  return (
    <div className="flex flex-col h-full border-r border-gray-200 overflow-hidden">
      ...
      <div className="flex items-center gap-3 p-6 border-b border-gray-200 bg-white">
        ...
        <div>
          <h1 className="text-lg font-semibold text-[#8300FF]">Admin</h1>
        </div>
      </div>
      ...
      <div className="border-t border-gray-200 p-4 bg-gray-50">
        ...
        <button 
          ...
          className="bg-white text-[#8300FF] font-bold text-[18px] px-4 py-3 w-full rounded-md border border-gray-200 hover:bg-red-50 hover:text-red-600 hover:border-red-200 transition-colors"
        >
          Logout
        </button>
      </div>
